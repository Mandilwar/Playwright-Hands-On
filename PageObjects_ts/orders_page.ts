...
export class orders_page
{
    page : Page;
    orders_table : Locator;
    order_table_rows : Locator;
    orders : any;
    ...
    async verify_order_click(cleaned_orderid : string)
    {
        ...
        {
            let orders : any;
            orders = (await this.order_table_rows.nth(i).locator("th").textContent() ?? "").trim();
