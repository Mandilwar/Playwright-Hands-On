...
let login_payload : any = {userEmail: "umang1112@gmail.com", userPassword: "Umang@1104812"};
let order_payload : any = {orders: [{country: "India", productOrderedId: "6960eae1c941646b7a8b3ed3"}]};
let response : any;
...
test('@API Automation Practice on E-commerce Website',async ({page})=>
    {
        ...
        for (let i = 0; i < rowsCount; i++) {
            let orders : any;
            orders = (await table_rows.nth(i).locator("th").textContent() ?? "").trim();
